...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['propertyType'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-sm text-red-600"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <div>
            ...
            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['keyFeatures'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-sm text-red-600"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <div>
            ...
            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['tone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-sm text-red-600"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <div class="mt-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <!--[if BLOCK]><![endif]--><?php if($seoScore !== null): ?>
                <div class="text-sm text-gray-600">SEO Score: <span class="font-semibold"><?php echo e($seoScore); ?>%</span></div>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        </div>

        <div class="mt-2 p-4 bg-gray-50 rounded min-h-[6rem]" id="generated-output">
            <!--[if BLOCK]><![endif]--><?php if($description): ?>
                <div class="prose max-w-none text-gray-800"><?php echo nl2br(e($description)); ?></div>
            <?php else: ?>
...
<?php /**PATH /Users/macbookpro2015/Documents/Dilmak/interview/property-description-generator/resources/views/livewire/property-form.blade.php ENDPATH**/ ?>